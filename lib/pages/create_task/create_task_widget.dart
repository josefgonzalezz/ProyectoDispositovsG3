...
class _CreateTaskWidgetState extends State<CreateTaskWidget> {
  ...
  void initState() {
    ...
    _model.subjectInputTextController ??= TextEditingController();
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.parsedate = await actions.parseDate(
                            _model.dueDateInputTextController.text,
                          );

                          var tasksRecordReference =
                              TasksRecord.collection.doc();
                          await tasksRecordReference.set(createTasksRecordData(
                            subject: _model.subjectInputTextController.text,
                            description:
                                _model.descriptionInputTextController.text,
                            owner: functions.parseUserDocument(currentUserUid),
                            createdDate: getCurrentTimestamp,
                            status: 'Pending',
                            statusDate: getCurrentTimestamp,
                            dueDate: _model.parsedate,
                          ));
                          _model.apiResult = TasksRecord.getDocumentFromData(
                          ...
                          if (_model.apiResult?.reference != null) {
                            context.pushNamed(HomePageWidget.routeName);
                          } else {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'We cant complete the task',
                                  style: TextStyle(
                                ...
                                backgroundColor: Color(0xFFE90707),
                              ),
                            );
                          }
